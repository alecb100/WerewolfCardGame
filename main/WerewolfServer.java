...
public class WerewolfServer implements Runnable {
    // List of people connected to the server, searched by name and holding their main.Player object associated with them
    ...
    // them for something
    public ConcurrentHashMap<String, String> gameActions;
    ...
    public void addPlayer(String playerName, Player player) {
        ...
        // This is because neighbors will point to a main.Player object that doesn't exist anymore. If it's started already,
    ...
    private class PlayerHandler implements Runnable {
        ...
        public void run() {
            try {
                ...
                if(!gameStart) {
                    // If the game hasn't started yet, create the main.Player object like normal
    ...
    private class GameRunner implements Runnable {
        ...
        private void readCards() throws FileNotFoundException {
            ...
            while(scanner.hasNextLine()) {
                ...
                int cardAmount = 1;
                // main.Cards can be in the form of 'werewolves' or 'werewolves x4', the second one meaning there are 4
                ...
                for(int i = 0; i < cardAmount; i++) {
                    ...
                    if (cardName.equalsIgnoreCase("villager") || cardName.equalsIgnoreCase("villagers")) {
                    ...
                    } else if(cardName.equalsIgnoreCase("huntress")) {
                        ...
                        System.out.println("main.Cards.Card not recognized.");
                        gameStart = false;
                        throw new IllegalArgumentException();
                    }
